...
export const ChunkSchemaInstance = (collectionName: string = "xstreamer.chunks") : Model<Document> => {
    collectionName = collectionName && collectionName.trim() || "xstreamer.chunks";
