...
function _getIndices(xmlString, subString) {
...
function _getEndTagIndices(xmlString, node) {
...
function _getStartTagIndices(xmlString, node) {
...
function _getMatchingEndIndex(startIndices, endIndices, index) {
...
function getNodeIndices(xmlString, node) {
